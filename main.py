...
page = st.sidebar.radio("Navigate", ["Upload & Process", "Database Management", "Settings"])
...
# Settings Page
    ...
    azure_endpoint = st.text_input("AZURE_OPENAI_ENDPOINT", value=st.secrets["azure_openai"]["deployment"])
